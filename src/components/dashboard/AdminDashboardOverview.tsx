  ...
  const DashboardSkeleton = () => (
    <div className="space-y-8">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 lg:gap-6">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="bg-gradient-to-br from-slate-50 to-white rounded-xl p-6 animate-pulse">
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 mb-2">Dashboard Amministratore</h1>
            <p className="text-slate-600">Panoramica generale del sistema</p>
          </div>
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200 shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-blue-900 mb-1">94.2%</div>
        ...
        <Card className="bg-gradient-to-br from-emerald-50 to-teal-50 border-emerald-200 shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-emerald-900 mb-1">87.5%</div>
        ...
        <Card className="bg-gradient-to-br from-purple-50 to-pink-50 border-purple-200 shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-purple-900 mb-1">92.8%</div>
