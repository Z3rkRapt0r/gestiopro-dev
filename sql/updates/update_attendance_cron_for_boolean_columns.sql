        ...
        LOOP
            ...
            FOR employee_record IN
                SELECT p.id, p.first_name, p.last_name, p.email,
                       ...
                       ews.monday as emp_monday, ews.tuesday as emp_tuesday, ews.wednesday as emp_wednesday, 
                       ews.thursday as emp_thursday, ews.friday as emp_friday, ews.saturday as emp_saturday, ews.sunday as emp_sunday,
            ...
            LOOP
                ...
                -- AGGIORNAMENTO: Usa le nuove colonne booleane per gli orari personalizzati
                IF employee_record.emp_start_time IS NOT NULL THEN
                    -- Dipendente ha orari personalizzati, usa le colonne booleane personalizzate
                    CASE current_day_name
                        WHEN 'monday' THEN is_working_day := employee_record.emp_monday;
                        WHEN 'tuesday' THEN is_working_day := employee_record.emp_tuesday;
                        WHEN 'wednesday' THEN is_working_day := employee_record.emp_wednesday;
                        WHEN 'thursday' THEN is_working_day := employee_record.emp_thursday;
                        WHEN 'friday' THEN is_working_day := employee_record.emp_friday;
                        WHEN 'saturday' THEN is_working_day := employee_record.emp_saturday;
                        WHEN 'sunday' THEN is_working_day := employee_record.emp_sunday;
                    END CASE;
                    expected_start_time := employee_record.emp_start_time;
                ELSE
                    -- Usa gli orari aziendali
                    CASE current_day_name
