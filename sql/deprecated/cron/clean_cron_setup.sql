-- Pulizia completa e ricreazione cron job
-- Rimuovi tutti i possibili cron job esistenti (ignora errori se non esistono)
DO $$
BEGIN
    -- Prova a rimuovere tutti i possibili cron job
    BEGIN
