-- =========================================
-- ✅ VERSIONE FINALE CORRETTA DELLA FUNZIONE
-- =========================================

-- Funzione corretta con ordine logico delle istruzioni
...
BEGIN
    -- Inizializzazione
    SELECT EXTRACT(DOW FROM current_timestamp_val)::text INTO current_day_name;
    ...
    -- IMPORTANTE: Questo controllo viene DOPO che alerts_created è stato calcolato!
