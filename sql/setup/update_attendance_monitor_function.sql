-- ============================================================================
-- AGGIORNA FUNZIONE attendance_monitor_cron() PER LEGGERE DA admin_settings
-- ============================================================================
-- Esegui questo script nel SQL Editor di Supabase Dashboard
-- DOPO aver eseguito add_supabase_config_columns.sql
-- ============================================================================
...
BEGIN
    ...
    BEGIN
        ...
        -- ========================================================================
        -- NUOVO: Leggi configurazione Supabase da admin_settings (UI-configurable!)
        -- ========================================================================
        IF alerts_created > 0 THEN
            ...
            BEGIN
                -- Leggi URL e chiave dalla tabella admin_settings
                ...
                WHERE supabase_url IS NOT NULL 
                  ...
                  AND attendance_alert_enabled = true
                LIMIT 1;

                IF v_supabase_url IS NULL OR v_service_role_key IS NULL THEN
                    RAISE WARNING '[Attendance Monitor Cron] Configurazione Supabase mancante! Vai in Impostazioni Admin → Presenze → Configurazione Supabase';
                    edge_response := 'ERRORE: Configurazione Supabase non trovata. Configura URL e Service Role Key nelle impostazioni.';
                ELSE
...
-- Verifica
SELECT '✅ Funzione attendance_monitor_cron() aggiornata con successo!' as status;
