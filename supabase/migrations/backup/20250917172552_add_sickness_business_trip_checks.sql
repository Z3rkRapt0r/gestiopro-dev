-- AGGIUNTA CONTROLLI PER MALATTIA E TRASFERTA NEL MONITORAGGIO PRESENZE
-- Questa migrazione aggiunge controlli aggiuntivi per evitare spam ai dipendenti
-- che sono in malattia o trasferta (oltre alle ferie e permessi già controllati)
